...
class Sms:
	...
	def menu(self):
		...
		time.sleep(1)
		print("\033[1;37mDidikan : \033[1;36mRED HAT")
		time.sleep(1)
		print("\033[1;37mDi Retas : \033[1;37mLhans Beutik")
		time.sleep(1)
		print("\033[1;37mTeam    : \033[1;32mSecurity Cyber Script Kiddie")
		time.sleep(1)
		print("\033[1;37mGithub  : \033[1;33mgithub.com/19LhansBeutik33")
		time.sleep(1)
		print("\033[1;31m______________________________________________\n")
		os.system('xdg-open https://facebook.com/LhansBeutik')
		o=int(0)
		time.sleep(2)
		...
		print("\033[1;31m______________________________________________")
		if jumlah > 100:
			exit("\033[1;37m[\033[1;31m!\033[1;37m] Jangan kebanyakan Bangsat!, kasian !!\n\033[1;37m[\033[1;31m!\033[1;37m] Sekali ngirim 100 aja\n")
		else:
